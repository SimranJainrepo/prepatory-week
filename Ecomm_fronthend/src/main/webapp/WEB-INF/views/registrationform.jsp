		...
		<div class="container">
			...
			<form:form action="${url }" modelAttribute="customer">
				...
				<div class="boxed" style="border: 1px solid">
					...
					<div class="form-group">
						<form:label path="lastname">Enter Lasttname</form:label>
				...
				<div class="boxed" style="border: 1px solid">
					...
					<div class="form-group">
						<form:label path="billingAddress.appartmentnumber">Enter Apartment number</form:label>
						<form:input path="billingAddress.appartmentnumber" />
						<form:errors path="billingAddress.appartmentnumber"
					...
					<div class="boxed" style="border: 1px solid">
						...
						<div class="form-group">
							<form:label path="shippingAddress.appartmentnumber">Enter Appartment number</form:label>
							<form:input path="shippingAddress.appartmentnumber" />
							<form:errors path="shippingAddress.appartmentnumber"
								cssStyle="color:red"></form:errors>
						</div>
						<div class="form-group">
